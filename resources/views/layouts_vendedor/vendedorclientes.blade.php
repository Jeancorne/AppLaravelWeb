@extends('layouts_vendedor/headervendedor')
@section('content')
<div>
    <input value="usuario" class="tipo" readonly type="hidden">
</div>
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 contenido_menu">
    <div class="menu">
        <ol class="breadcrumb">
            <button type="button" class="btn btn-primary btnCerrarSesion">Cerrar Sesión</button>
        </ol>
        <ol class="breadcrumb">
            <button type="button" class="btn btn-primary btnCrearUsuario">Crear Clientes</button>
        </ol>        
        <div class="row">
